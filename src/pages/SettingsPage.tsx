...
export function SettingsPage() {
  ...
  const companyPreviewUri = logoDataUri(
    settings.logo_base64,
    settings.logo_mime,
  );
  const clientPreviewUri = logoDataUri(
    settings.client_logo_base64,
    settings.client_logo_mime,
  );
    ...
    <div className="flex-1 overflow-y-auto p-6">
      <div className="max-w-6xl mx-auto">
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400 mb-6">
          Les logos société et client apparaîtront sur tous les exports Excel
          (gauche et droite de l&apos;en-tête).
        </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
          <div className="lg:col-span-3 space-y-6">
            <section className="card p-5">
              ...
              <div className="mt-4 p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg text-xs text-gray-600 dark:text-gray-300 space-y-1">
                <p className="font-medium">
                  ℹ️ Conseils pour un rendu optimal dans les exports :
                </p>
                <ul className="list-disc list-inside space-y-0.5 text-gray-500 dark:text-gray-400">
                  <li>
                    Utilisez un logo sur fond transparent (PNG recommandé)
                  </li>
                  <li>Résolution minimale recommandée : 300×100 px</li>
                  <li>
                    Le logo société apparaîtra en haut à gauche, le logo client
                    en haut à droite de chaque feuille Excel
                  </li>
                </ul>
              </div>
            </section>
            ...
            <section className="card p-5">
              ...
              <div className="mt-4 p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg text-xs text-gray-600 dark:text-gray-300 space-y-1">
                <p className="font-medium">
                  ℹ️ Ce logo remplace les informations société à droite :
                </p>
                <ul className="list-disc list-inside space-y-0.5 text-gray-500 dark:text-gray-400">
                  <li>Affiché en haut à droite de chaque export Excel</li>
                  <li>
                    Sans logo client, le nom du client du projet sera affiché à
                    la place
                  </li>
                </ul>
              </div>
                ...
                >
                  <div className="w-[28%] flex items-center justify-center p-2 border-r border-white/10">
                    {companyPreviewUri ? (
                      ...
                      <span className="text-white/50 text-xs text-center px-1">
                        Logo société
                      </span>
                    )}
                  </div>
                  ...
                  <tbody>
                    {[
                      ...
                      <tr
                        key={ri}
                        className={
                          ri % 2 === 1 ? "bg-gray-50 dark:bg-gray-900/50" : ""
                        }
                      >
                        {row.map((cell, ci) => (
                          <td
